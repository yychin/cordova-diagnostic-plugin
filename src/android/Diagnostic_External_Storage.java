...
public class Diagnostic_External_Storage extends CordovaPlugin{
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            ...
            } else if(action.equals("getExternalStorageAuthorizationStatus")){
                this.getExternalStorageAuthorizationStatus(callbackContext); 
            } else {
    ...
    private void getExternalStorageAuthorizationStatus(JSONArray args, CallbackContext callbackContext) throws Exception{
